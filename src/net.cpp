...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RonPaulCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ronpaulcointools.com", "dnsseed.ronpaulcointools.com"},
    {"ronpaulcoinpool.org", "dnsseed.ronpaulcoinpool.org"},
    {"xurious.com", "dnsseed.RPC.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"ronpaulcointools.com", "testnet-seed.ronpaulcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RonPaulCoin is probably already running."), addrBind.ToString().c_str());
        else
